package com.diasporabridge.backend.user.service;
...
import com.diasporabridge.backend.auth.dto.RegistrationRequest;
...
import com.diasporabridge.backend.common.exception.EmailAlreadyExistsException;
import com.diasporabridge.backend.common.exception.ExpiredTokenException;
import com.diasporabridge.backend.common.exception.InvalidTokenException;
...
public class UserServiceImpl implements UserService {
	...
	*/
	...
	public void resendVerificationToken(String email) {
		...
		Optional<VerificationToken> optToken = verificationTokenRepo.findByUserId(user.getId());
	...
	public Page<User> getAllActiveUsers(Pageable pageable) {
		return usersRepository.findByIsActiveTrueAndDeletedAtIsNull(pageable);
	}
