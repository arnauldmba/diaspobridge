...
public class TransporterTripRestController {
	...
	List <TransporterTrip> getAllTransporterTrip(){
		return this.transporterTripService.getAllTransporterTrip();
	}
    ...
    // Creer un trip 
    @PostMapping
    public TransporterTrip createTrip(@RequestBody TransporterTrip trip) {
        return transporterTripService.saveTransporterTrip(trip);
    }
    
    // Modifier un trip
    @PutMapping("/{id}")
    public TransporterTrip updateTrip(@PathVariable Long id, @RequestBody TransporterTrip updatedTrip) {
        updatedTrip.setId(id);
        return transporterTripService.updateTransporterTrip(updatedTrip);
    }
    
    // Supprimer un trip par ID
    @DeleteMapping("/{id}")
    public void deleteTrip(@PathVariable Long id) {
        transporterTripService.deleteTransporterTripById(id);
    }
